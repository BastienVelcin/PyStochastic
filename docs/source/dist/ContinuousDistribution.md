...
The `ContinuousDistribution` class provides a framwork for implementing some
continuous distributions in PyStochastic.
Please note that this class is an abstract class, which means that it cannot be
